...
<script type="text/javascript">
		...
		function tablolariGetir() {
			...
			$("<option>").val(tablo.tabloAdi).text(tablo.tabloAdi).appendTo($select);
				});
					});
			}
		...
		function kolonlariGetir(tabloAdi) {
			...
			$.each(responseJson, function(index, kolon) {
				trHTML += '<tr class="kolonSatir"><td>' + kolon.columnName+ '</td><td id="2""><input type="text" class ="kolonDeger" id ='+kolon.columnName+'></input></td><td></tr>';
				});
		...
		function degerEkle(){
			...
			$.post("KolonGetir",{
			tabloAdi : $("#seciliTabloAdi").val(),kolonDegerListesi : JSON.stringify(columnValueList)}, function(responseJson) {});
...
<body>
		<form name="frmDB" id="frmId" action="Servlet" accept-charset="UTF-8" method="post">
			<table border="1" width="700" height="250" align="center">
				<tr align="center">
					<td colspan="2">Tablo Adı :</td>
					<td colspan="3">
						<input type="text" id="txtTable"name="txtTable">
					</td>
				</tr>
					<tr align="center">
					<td>Kolon Adı :</td>
					<td>
						<input type="text" id="txtKolon" name="txtKolon">
					</td>
					<td>Veri Tipi :</td>
					<td>
						<input type="text" id="txtVeri" name="txtVeri">
					</td>
					<td>
						<input type="button" id="btnKlnEkle" name="btnKlnEkle" value="KOLON EKLE" onclick="ekle()">
					</td>
				</tr>
				<tr>

					<td colspan="5" align="center">
						<input type="button" id="kayit"name="kayit" value="KAYIT" onclick="callServlet()">
					</td>
				</tr>
			</table>
		...
		<form name="frm2" id="frm2" accept-charset="UTF-8" method="post">
			<table border="1" width="500" height="250" align="center">
				<tr align="center">
					<td>Tablo Adı :</td>
					<td>
						<select id="dropdownlist" name="dropdownlist" onchange="onChangeDropDown(this);">
						</select>
					</td>
				</tr>
				<tr align="center">
				...
				<tr>
					<td colspan="2" align="center">
						<input type="button" id="kayit2" name="kayit2" value="KAYIT" onClick="degerEkle()">
					</td>
				</tr>
			</table>
